        ...
        static void Main(string[] args)
        {
            ...
            switch (input)
            {
                ...
                case "3":
                    ...
                    var multipleNumber2 = Console.ReadLine();

                    if (int.TryParse(multiplyNumber1, out int multipleNumOne) && int.TryParse(multipleNumber2, out int multipleNumTwo))
                    {
                        Console.Write($"{multipleNumOne} * {multipleNumTwo} = ");
                        Console.Write(calculator.Multiply(multipleNumOne, multipleNumTwo));
                    }
                    else
                    {
                        Console.WriteLine("One or more of the numbers is not an int");
